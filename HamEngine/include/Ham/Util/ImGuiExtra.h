...
{
  std::sort(entityList.begin(), entityList.end(), [](Ham::Entity &a, Ham::Entity &b) { return a.GetComponent<Ham::Component::Tag>().Order < b.GetComponent<Ham::Component::Tag>().Order; });
}
